<script setup>
import TrailerVideo from '../TrailerVideo.vue'

import QuietPlace from '@/assets/trailers/quiet-place.mp4'
...
<template>
  <div class="relative px-3 min-h-dvh">
    ...
    <div class="absolute flex flex-col gap-3 top-1/4 left-10">
      <p
        data-aos="fade-up"
        data-aos-delay="3000"
