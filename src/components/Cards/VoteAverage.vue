<script setup>
const vote = (vote) => Math.ceil((vote / 10) * 5)
    ...
    <template v-for="index in 5" :key="index">
      <div class="radio">
        <input
          ...
          type="radio"
          :name="`rating-${index}`"
          :checked="index <= vote(value)"
          disabled
        />
        <label :for="`rating-${index}`" title="5 stars">
          <svg viewBox="0 0 576 512" height="0.7em" xmlns="http://www.w3.org/2000/svg">
            <path
